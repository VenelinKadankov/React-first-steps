    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onClickEdit(_id)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onClickDelete(_id)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => onClickDetails(_id)}>
